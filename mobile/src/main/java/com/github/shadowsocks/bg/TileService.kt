...
class TileService : BaseTileService(), ShadowsocksConnection.Callback {
    ...
    private val iconConnected by lazy { Icon.createWithResource(this, com.github.shadowsocks.core.R.drawable.ic_service_active) }
    ...
    private fun updateTile(serviceState: BaseService.State, profileName: () -> String?) {
        qsTile?.apply {
            ...
            label = label ?: getString(com.github.shadowsocks.core.R.string.app_name)
            updateTile()
        }
    }
